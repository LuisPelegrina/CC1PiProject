...
void MissReconstructionClassifier_Reorganized()
{
  ...
  for(int i_e = 0; i_e < nEntries; ++i_e) {
    ...
    if(extra_slice && !has_activity_near_true_vertex) {
      ...
      if(distance_to_true_vertex < 2) {
        cases_cont["000_vertex_ok"]++;
      } else {
        cases_cont["000_miss_vertex"]++;
        show = false;
        if(distance_to_true_vertex > 6)  {
          cases_cont["000_miss_vertex_6m"]++;
          show = false;
        }
      }
      ...
      if((cont_by_pdg[211] + cont_by_pdg[13]) == 2) {
        ...
        if((cont_by_pdg[211] == 1) && (cont_by_pdg[13] == 1)) {
          ...
          if((cont_by_pdg[22222] == 2) && (good_vertex)) {
            ...
            cases_cont[case_name]++;
            //if(good_vertex && long_enought) show = true;
